...
import { verifyAuth } from "../middlewares/MainPostsMiddlewares.js";
...
postsRoutes.post("/posts", verifyAuth, async (req, res) => {
...
postsRoutes.put("/posts/:id", verifyAuth, async (req, res) => {
	const { id } = req.params;
	const { title, content } = req.body;
...
postsRoutes.delete("/posts/:id", verifyAuth, async (req, res) => {
	const { id } = req.params;
